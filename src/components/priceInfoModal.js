    ...
    render() {
      return (
        <div style={{ display : 'inline'}}>
          <Typography style={{ display : 'inherit', cursor : 'pointer', fontSize : 'inherit', fontWeight : 'bold' }} color="inherit" onClick={this.handleClickOpen} >{<NumberFormat value={this.props.price.totalprice} displayType={'text'} thousandSeparator={true} />}</Typography>
